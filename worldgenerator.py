...
def newsystem():
    ...
    typesofplanet=['EarthLike','Forest','Desert','Oceans','Ice','Gas']
    ...
    for i in range(nplanets):
        nptype.append(typesofplanet[np.random.randint(0,6)])
        ...
        for i in range(shape[0]):
            for j in range(shape[1]):
                if systemnew[i][j] == 0:
                    ...
                    elif nptype[0] is 'Gas':
                        systemmap=systemmap+(f'{color.lightmagenta}+{color.end}')
...
for p in range(nplanets):
    ...
    planet = np.zeros(shape)
    for i in range(shape[0]):
        for j in range(shape[1]):
            planet[i][j] = noise.pnoise2(i/scale,
                                        j/scale,
                                        octaves=octaves,
    ...
    newplanet = np.zeros_like(planet)

    for i in range(shape[0]):
        for j in range(shape[1]):
            if mask[i][j]:
                newplanet[i][j] = planet[i][j]
            else:
                newplanet[i][j] = -0.8
    ...
    elif list(reversed(nptype))[p] is 'Gas':
        def transform(newplanet):
            global nc, planetmap
            planetmap = ''
            for i in range(shape[0]):
                for j in range(shape[1]):
                    if newplanet[i][j] == -0.8:
                        ...
                        planetmap+=(f'{color.magenta}+{color.end}')
                    elif newplanet[i][j] < -0.29:
                        nc = (nc + 1)
                        if nc > 4:
                            planetmap+=(f'{color.lightblue}~{color.end}')
                        ...
                        planetmap+=(f'{color.lightmagenta}+{color.end}')
                    elif newplanet[i][j] < 0.6:
                        planetmap+=(f'{color.lightmagenta}*{color.end}')
                    elif newplanet[i][j] < 1.0:
                        planetmap+=(f'{color.lightmagenta}*{color.end}')
        ...
        def transform(city):
            ...
            if type is 'EarthLike':
                if k is 0:
                    ...
                    placeslist=['SPACEPORT']
                    cityoptions = f'{f"1){placeslist[0]}":.^75}\n' \
                             f'...........................................................................\n' \
                             f'...........................................................................\n' \
                             f'...........................................................0)BACK..........'
                elif k is 1:
                    ...
                    placeslist=['SPACEPORT','']
                    cityoptions = f'{f"1){placeslist[0]}...2){placeslist[1]}":.^75}\n' \
                             f'...........................................................................\n' \
                             f'...........................................................................\n' \
                             f'...........................................................0)BACK..........'
                elif k is 2:
                    ...
                    placeslist = ['SPACEPORT', '', '']
                    cityoptions = f'{f"1){placeslist[0]}...2){placeslist[1]}...3){placeslist[2]}":.^75}\n' \
                             f'...........................................................................\n' \
                             f'...........................................................................\n' \
                             f'...........................................................0)BACK..........'
                elif k is 3:
                    ...
                    placeslist = ['SPACEPORT', '', '', '']
                    cityoptions = f'{f"1){placeslist[0]}...2){placeslist[1]}...3){placeslist[2]}...4){placeslist[3]}":.^75}\n' \
                             f'...........................................................................\n' \
                             f'...........................................................................\n' \
                             f'...........................................................0)BACK..........'
                elif k is 4:
                    ...
                    placeslist = ['SPACEPORT', '', '', '', '','']
                    cityoptions = f'{f"1){placeslist[0]}...2){placeslist[1]}...3){placeslist[2]}...4){placeslist[3]}":.^75}\n' \
                              f'{f"5){placeslist[4]}...6){placeslist[5]}":.^75}\n' \
                             f'...........................................................................\n' \
                             f'...........................................................0)BACK..........'
                elif k is 6:
                    ...
                    placeslist = ['SPACEPORT', '', '', '', '','','']
                    cityoptions = f'{f"1){placeslist[0]}...2){placeslist[1]}...3){placeslist[2]}...4){placeslist[3]}":.^75}\n' \
                              f'{f"5){placeslist[4]}...6){placeslist[5]}...7){placeslist[6]}":.^75}\n' \
                             f'...........................................................................\n' \
                             f'...........................................................0)BACK..........'
                elif k is 7:
                    ...
                    placeslist = ['SPACEPORT', '', '', '', '','','','']
                    cityoptions = f'{f"1){placeslist[0]}...2){placeslist[1]}...3){placeslist[2]}...4){placeslist[3]}":.^75}\n' \
                              f'{f"5){placeslist[4]}...6){placeslist[5]}...7){placeslist[6]}...8){placeslist[7]}":.^75}\n' \
                             f'...........................................................................\n' \
                             f'...........................................................0)BACK..........'
                elif k is 8:
                    ...
                    cityoptions = f'{f"1){placeslist[0]}...2){placeslist[1]}...3){placeslist[2]}...4){placeslist[3]}":.^75}\n' \
                              f'{f"5){placeslist[4]}...6){placeslist[5]}...7){placeslist[6]}...8){placeslist[7]}":.^75}\n' \
                              f'{f"9){placeslist[8]}...10){placeslist[9]}":.^75}\n' \
                              f'...........................................................0)BACK..........'
                elif k is 10:
                    ...
                    cityoptions = f'{f"1){placeslist[0]}...2){placeslist[1]}...3){placeslist[2]}...4){placeslist[3]}":.^75}\n' \
                              f'{f"5){placeslist[4]}...6){placeslist[5]}...7){placeslist[6]}...8){placeslist[7]}":.^75}\n' \
                              f'{f"9){placeslist[8]}...10){placeslist[9]}...11){placeslist[10]}":.^75}\n' \
                              f'...........................................................0)BACK..........'
                elif k is 11:
                    ...
                    cityoptions = f'{f"1){placeslist[0]}...2){placeslist[1]}...3){placeslist[2]}...4){placeslist[3]}":.^75}\n' \
                              f'{f"5){placeslist[4]}...6){placeslist[5]}...7){placeslist[6]}...8){placeslist[7]}":.^75}\n' \
                              f'{f"9){placeslist[8]}...10){placeslist[9]}...11){placeslist[10]}...12){placeslist[11]}":.^75}\n' \
                              f'...........................................................0)BACK..........'
                elif k is 12:
                    ...
                    cityoptions = f'{f"1){placeslist[0]}...2){placeslist[1]}...3){placeslist[2]}...4){placeslist[3]}":.^75}\n' \
                              f'{f"5){placeslist[4]}...6){placeslist[5]}...7){placeslist[6]}...8){placeslist[7]}":.^75}\n' \
                              f'{f"9){placeslist[8]}...10){placeslist[9]}...11){placeslist[10]}...12){placeslist[11]}":.^75}\n' \
                              f'{f"13){placeslist[12]}.....................0)BACK":.^75}'
                else:
                    ...
                    cityoptions = f'{f"1){placeslist[0]}...2){placeslist[1]}...3){placeslist[2]}...4){placeslist[3]}":.^75}\n' \
                              f'{f"5){placeslist[4]}...6){placeslist[5]}...7){placeslist[6]}...8){placeslist[7]}":.^75}\n' \
                              f'{f"9){placeslist[8]}...10){placeslist[9]}...11){placeslist[10]}...12){placeslist[11]}":.^75}\n' \
                              f'{f"13){placeslist[12]}...14){placeslist[13]}..................0)BACK":.^75}'
            elif type is 'Forest':
                if k is 0:
                    availableplacesnumber = ['0', '1']
                    placeslist = ['']
